...
def numinwords(no):
	unit = ['ONE','TWO','THREE','FOUR','FIVE','SIX','SEVEN','EIGHT','NINE','TEN','ELEVEN','TWELVE','THIRTEEN','FOURTEEN','FIFTEEN','SIXTEEN','SEVENTEEN','EIGHTEEN','NINETEEN','TWENTY']
	...
	if len(segmented)==1:
		...
		if number0==0 and number1==0 and number2==0:
			...
			return converter(segmented[0]) +" "+supers[1] + " "+converter(segmented[1]) + " ONLY"		
		...
		if sec1!=0 and sec2==0 and sec3==0:
			...
			return converter(segmented[0])+" "+supers[2]+" "+converter(segmented[2]) + " ONLY"
		elif sec1!=0 and sec2!=0 and sec3==0:
			return converter(segmented[0])+" "+supers[2]+" "+converter(segmented[1]) +" "+supers[1] +" ONLY"
		else:
			return converter(segmented[0])+" "+supers[2]+" "+converter(segmented[1]) +" "+supers[1] + " "+converter(segmented[2]) + " ONLY"
		...
		if sec1!=0 and sec2!=0 and sec3!=0 and sec4==0:
			return converter(segmented[0])+" "+supers[3]+" " + converter(segmented[1])+" "+supers[2]+" "+converter(segmented[2]) +" "+supers[1] + " ONLY"			
		elif sec1!=0 and sec2!=0 and sec3==0 and sec4!=0:
			return converter(segmented[0])+" "+supers[3]+" " + converter(segmented[1])+" "+supers[2]+" "+converter(segmented[3]) + " ONLY"
		elif sec1!=0 and sec2==0 and sec3!=0 and sec4!=0:
			return converter(segmented[0])+" "+supers[3]+" "+converter(segmented[2]) +" "+supers[1] + " "+converter(segmented[3]) + " ONLY"
		elif sec1!=0 and sec2!=0 and sec3==0 and sec4==0:
			return converter(segmented[0])+" "+supers[3]+" " + converter(segmented[1])+" "+supers[2]+ " ONLY"
		elif sec1!=0 and sec2==0 and sec3==0 and sec4!=0:
			return converter(segmented[0])+" "+supers[3]+" " +converter(segmented[3]) + " ONLY"
		elif sec1!=0 and sec2==0 and sec3!=0 and sec4==0:
			return converter(segmented[0])+" "+supers[3]+" " +converter(segmented[2]) +" "+supers[1]+ " ONLY"
		elif sec1!=0 and sec2==0 and sec3==0 and sec4==0:
			return converter(segmented[0])+" "+supers[3]+" ONLY"	
		else:
			return converter(segmented[0])+" "+supers[3]+" " + converter(segmented[1])+" "+supers[2]+" "+converter(segmented[2]) +" "+supers[1] + " "+converter(segmented[3]) + " ONLY"
